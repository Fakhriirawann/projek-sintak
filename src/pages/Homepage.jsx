...
const Homepage = () => {
  ...
  <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
    ...
    <p className="text-lg sm:text-xl text-rose-800 mb-6 font-medium">
      Beli <span className="font-bold text-white bg-rose-500 px-2 py-0.5 rounded-md shadow-sm">3</span> Gratis <span className="font-bold text-white bg-rose-500 px-2 py-0.5 rounded-md shadow-sm">1</span> untuk semua varian cookies 🍪
    </p>
    <Link
      to="/catalog"
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-12">
      <h2 className="text-3xl lg:text-4xl font-bold text-rose-700 mb-4">
        Produk <span className="text-pink-500">Best Seller</span>
      </h2>
      <p className="text-xl text-gray-600">Cookies favorit pelanggan kami</p>
    </div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-12">
      <h2 className="text-3xl lg:text-4xl font-bold text-rose-700 mb-4">
        Mengapa Pilih <span className="text-pink-500">SweetMelt?</span>
      </h2>
      <p className="text-gray-600 text-lg">
        Kami memberikan yang terbaik untuk pengalaman cookies yang tak terlupakan 🍪
      </p>
    </div>
